...
- [Fases Aprendizaje Supervisado (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L10.ipynb)
- [Vídeo de recapitulación de conceptos clave (YOUTUBE)](https://youtu.be/yeSjA9QJFLU)
...
- Ejemplo de un modelo para clasificación (Inicio - Parte 1)
  ...
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L21.ipynb)
 ...
 - Ejemplo Naive Bayes (Parte 2)
   - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L22.ipynb)        
...
- Ejemplo K-Nearest Neighbors (Parte 3)
  ...
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L23.ipynb)    
...
- Ejemplo Regresión Logística (Parte 4)
  ...
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L24.ipynb)       
  - [Vídeo explicativo (YOUTUBE)](https://youtu.be/tVkQR2e-iyw)  

- Ejemplo Support Vector Machines (Parte 5)
  - [Vídeo de recapitulación de conceptos clave (YOUTUBE)](https://youtu.be/r4ZuL3iX9eU)
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L25.ipynb)     
  - [Vídeo explicativo (YOUTUBE)](https://youtu.be/KkvDhv_rFBo)  

- Ejemplo Decision Trees y Random Forest (Parte 6 y Parte 7)
  - [Vídeo de recapitulación de conceptos clave (YOUTUBE)](https://youtu.be/ub2jPEATEHM)
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L26.ipynb)     
  - [Vídeo explicativo (YOUTUBE)](https://youtu.be/NYYOUQ1UMM4)  

- Ejemplo Adaboost (Parte 8)
  - [Vídeo de recapitulación de conceptos clave (YOUTUBE)](https://youtu.be/7HvUTNZtikY)
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L27.ipynb)      
  - [Vídeo explicativo (YOUTUBE)](https://youtu.be/HUguHb5uGUw)

- Ejemplo de un modelo para clasificación (Final)
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L28.ipynb)
  - [Vídeo explicativo (YOUTUBE)](https://youtu.be/L0DvFGtwo38)
    
- Otro ejemplo completo de clasificación  
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L29.ipynb)  
  ...
  - [Vídeo explicativo (YOUTUBE)](https://youtu.be/GMsA2fVC_VA)
...
- Ejemplo de un modelo para regresión (Inicio - Parte 1)
  ...
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L31.ipynb)
...
- Ejemplo Regresión lineal (Parte 2)
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L32.ipynb)  
...
- Ejemplo Support Vector Machines (Parte 3)
  ...
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L33.ipynb)  
...
- Ejemplo Decision Trees y Random Forest (Parte 4)
  ...
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L34.ipynb)   
...
- Ejemplo Adaboost (Parte 5)
  ...
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L35.ipynb)  
  - [Vídeo explicativo (YOUTUBE)](https://youtu.be/_rIGQyPuqug)  

- Ejemplo de un modelo para regresión (Final - Parte 6)
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L36.ipynb)
  - [Vídeo explicativo (YOUTUBE)](https://youtu.be/PvqMftnLaZg)

- Otro ejemplo completo de regresión  
  - [Notebook (COLAB)](https://colab.research.google.com/github/mireiaconsarnau/machine_learning/blob/main/unidad3/cuadernos/U3L37.ipynb)  
